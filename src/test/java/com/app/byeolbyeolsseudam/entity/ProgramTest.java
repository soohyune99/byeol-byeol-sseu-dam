...
//    ProgramDynamicRepository programDynamicRepository;
    ...
    public void saveProgramTest(){
        ...
        programDTO01.setProgramName("친환경요리 만들기1 - 중화요리");
        ...
        programDTO02.setProgramName("친환경요리 만들기2 - 퓨전요리");
        ...
        programDTO03.setProgramName("친환경요리 만들기3 - 한식");
        ...
        programDTO03.setProgramStatus(ProgramStatus.모집예정);
        ...
        programDTO04.setProgramName("아이와 함께 만드는 친환경 요리");
        ...
        programDTO04.setProgramStatus(ProgramStatus.모집예정);
        ...
        programDTO05.setProgramName("아이와 함께 만드는 비건 레시피");
        ...
        programDTO06.setProgramName("아이와 함께하는 쓰담수거");
        ...
        programDTO06.setProgramStatus(ProgramStatus.모집예정);
        ...
        programDTO07.setProgramName("ZERO WASTE & 쓰담 2");
        ...
        programDTO07.setProgramStatus(ProgramStatus.모집예정);
        ...
        programDTO08.setProgramName("ZERO WASTE & 쓰담 3");
        ...
        programDTO08.setProgramStatus(ProgramStatus.모집완료);
        ...
        programDTO09.setProgramName(" ZERO WASTE & 쓰담 4");
        ...
        programDTO10.setProgramName("ZERO WASTE & 쓰담 5");
        ...
        programDTO10.setProgramStatus(ProgramStatus.모집완료);
        ...
        programDTO11.setProgramName("ZERO WASTE & 쓰담 6");
        ...
        programDTO12.setProgramName("ZERO WASTE & 쓰담 SPECIAL");
